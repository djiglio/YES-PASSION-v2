        ...
        content.innerHTML = `
            <div class="setup-container" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 70vh;">
                ...
                <div class="setup-modes" style="max-width: 800px; width: 100%; margin: 0 auto; display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <button id="btn-sp" class="cl-card" style="width: 100%; border: 1px solid rgba(16, 185, 129, 0.3); padding: 2rem; border-radius: 16px; background: rgba(16, 185, 129, 0.05); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.3); cursor: pointer; text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 0.5rem; transition: all 0.3s ease;">
                    ...
                    <button id="btn-mp" class="cl-card" style="width: 100%; border: 1px solid rgba(59, 130, 246, 0.3); padding: 2rem; border-radius: 16px; background: rgba(59, 130, 246, 0.05); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.3); cursor: pointer; text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 0.5rem; transition: all 0.3s ease;">
